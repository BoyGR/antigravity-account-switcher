...
exports.registerSaveCurrentAccountCommand = registerSaveCurrentAccountCommand;
...
const COMMAND_ID = "boygr.antigravityAccountSwitcher.saveCurrentAccount";
function registerSaveCurrentAccountCommand(context) {
    const disposable = vscode.commands.registerCommand(COMMAND_ID, async () => {
        try {
            ...
            const existing = (0, account_registry_1.findManagedAccount)(context, current.email);
            const label = await vscode.window.showInputBox({
                title: "Save Antigravity Account",
                prompt: "Optional local label for this account",
...
//# sourceMappingURL=save-current-account.js.map