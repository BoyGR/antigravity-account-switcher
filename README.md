...
1. Download the latest `antigravity-account-switcher-1.4.4.vsix` from [GitHub Releases](https://github.com/BoyGR/antigravity-account-switcher/releases).
...
3. **Via Terminal / Command Line**:
   - **Visual Studio Code**:
     ```powershell
     code --install-extension antigravity-account-switcher-1.4.4.vsix
     ```
   - **Google Antigravity Standalone IDE**:
     ```powershell
     antigravity --install-extension antigravity-account-switcher-1.4.4.vsix
     ```
   - **Cursor**:
     ```powershell
     cursor --install-extension antigravity-account-switcher-1.4.4.vsix
     ```
